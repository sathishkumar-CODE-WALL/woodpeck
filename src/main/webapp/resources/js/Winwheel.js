...
function winwheelAnimationLoop()
{
    if (winwheelToDrawDuringAnimation)
    {
        ...
        {
            //++ Check / tidy up external canvas thing.
			winwheelToDrawDuringAnimation.etx.clearRect(0, 0, winwheelToDrawDuringAnimation.externalCanvas.width, winwheelToDrawDuringAnimation.externalCanvas.height);
		}
